...
**Argo v2.0** is a Monte Carlo simulation add-in for Microsoft Excel (Office 365), rebuilt from scratch using modern web technologies (TypeScript, React, Office.js). This is a **reverse engineering effort** - the original source code was lost, and this project recreates it using AI assistance based on available documentation.
